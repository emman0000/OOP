...
public:
    // Para constructor
    Office(string location = " ", int SeatingCap = 0, string furniture[3] = {" ", " ", " "})
        : Location(location), SeatingCapacity(SeatingCap) { // using a member initialisation list here and default values as mentioned 
        for(int i = 0; i < 3; i++) {
